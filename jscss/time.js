function showTime() {
	...
	var startDate = new Date('2020/8/26 12:45:00');
	...
	if (seconds < 10)
	seconds = "0" + seconds;
	var currentTimeString = "<br><br>Dear Niu:<br>"
		...
		+	"<c style=\"color: #4472C4; text-shadow:2px 3px 3px #0ff; font-family:Microsoft YaHei; font-size:20px\" >-------- LL </c>";
